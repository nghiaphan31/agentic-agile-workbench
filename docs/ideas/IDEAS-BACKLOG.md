...
| IDEA-008 | OpenRouter MinMax M2.7 as default LLM with Claude fallback on consecutive errors | Human | 2026-03-28 | [IN PROGRESS] | v2.1 | Implementation on feature/IDEA-008-openrouter |
